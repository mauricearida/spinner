...
var wheel_arr = [
  {
    src: "assets/item_wheel_01.png",
    highlight: "assets/item_wheel_01_h.png",
    color: "#FDCC09",
    regX: 1,
    regY: 223,
    point: 10,
  ...
  {
    src: "assets/item_wheel_02.png",
    highlight: "assets/item_wheel_02_h.png",
    color: "#F37621",
    regX: 1,
    regY: 223,
    point: 25,
  ...
  {
    src: "assets/item_wheel_03.png",
    highlight: "assets/item_wheel_03_h.png",
    color: "#7DB544",
    regX: 1,
    regY: 223,
    point: 50,
  ...
  {
    src: "assets/item_wheel_04.png",
    highlight: "assets/item_wheel_04_h.png",
    color: "#1A9DD8",
    regX: 1,
    regY: 223,
    point: 80,
  ...
  {
    src: "assets/item_wheel_05.png",
    highlight: "assets/item_wheel_05_h.png",
    color: "#3F559A",
    regX: 1,
    regY: 223,
    point: 100,
  ...
  {
    src: "assets/item_wheel_06.png",
    highlight: "assets/item_wheel_06_h.png",
    color: "#91328B",
    regX: 1,
    regY: 223,
    point: 1000,
  ...
  {
    src: "assets/item_wheel_07.png",
    highlight: "assets/item_wheel_07_h.png",
    color: "#449BD4",
    regX: 1,
    regY: 223,
    point: 250,
  ...
  {
    src: "assets/item_wheel_08.png",
    highlight: "assets/item_wheel_08_h.png",
    color: "#F37621",
    regX: 1,
    regY: 223,
    point: 500,
  ...
  {
    src: "assets/item_wheel_09.png",
    highlight: "assets/item_wheel_09_h.png",
    color: "#FDCC09",
    regX: 1,
    regY: 223,
    point: 25,
  ...
  {
    src: "assets/item_wheel_10.png",
    highlight: "assets/item_wheel_10_h.png",
    color: "#7DB544",
    regX: 1,
    regY: 223,
    point: 0,
  ...
  {
    src: "assets/item_wheel_11.png",
    highlight: "assets/item_wheel_11_h.png",
    color: "#DA2027",
    regX: 1,
    regY: 223,
    point: 1000000000,
  ...
  {
    src: "assets/item_wheel_12.png",
    highlight: "assets/item_wheel_12_h.png",
    color: "#475C70",
    regX: 1,
    regY: 223,
    point: 0,
...
var shareMessage =
  "[SCORE]PTS is mine new highscore on Lucky Wheels Game! Try it now!"; //social share score message
...
function goPage(page) {
  ...
  switch (page) {
    ...
    case "result":
      ...
      resultScoreTxt.text = textDisplay.resultScoreText.replace(
        "[NUMBER]",
...
function stopGame() {
  ...
  if (gameSettings.secondWheel) {
    for (var n = 0; n < wheelSecond_arr.length; n++) {
      ...
      //slot color feature
      if (
        wheelSecond_arr[n].slot != undefined &&
        wheelSecond_arr[n].slot.highlightColor != ""
      ) {
...
function toggleInstruction(con) {
  if (con) {
    ...
    TweenMax.to(instructionTxt, 0.2, { delay: 1, alpha: 1, overwrite: true });
  } else {
    TweenMax.to(instructionTxt, 0.2, { alpha: 0, overwrite: true });
  }
}
...
function generateTickets() {
  ...
  gameData.totalTickets =
    gameData.totalTickets >= maxDisplayTicket
      ? maxDisplayTicket
      : gameData.totalTickets;
...
function animateNextTicket() {
  ...
  for (var n = 0; n < gameData.totalTickets; n++) {
    ...
    TweenMax.to($.ticket[n], 0.5, {
      x: newX,
      overwrite: true,
      onComplete: animateNextTicketDone,
    });
  }
}
...
function loopBetNumber() {
  ...
  betData.timer -= 100;
  betData.timer =
    betData.timer < betData.timerMin ? betData.timerMin : betData.timer;
...
function updateBetNumber() {
  ...
  betData.betNumber =
    betData.betNumber >= gameSettings.gameMaxBet
      ? gameSettings.gameMaxBet
      : betData.betNumber;
  betData.betNumber =
    betData.betNumber >= availableCredit ? availableCredit : betData.betNumber;
...
function updateStat() {
  if (gameSettings.gamePlayType) {
    chanceTxt.text = textDisplay.chancesText.replace(
      "[NUMBER]",
      playerData.chance
    );
    creditTxt.text = textDisplay.creditText.replace(
      "[NUMBER]",
      addCommas(Math.floor(playerData.point))
    );
  } else {
    creditTxt.text = textDisplay.creditText.replace(
      "[NUMBER]",
    ...
    betTxt.text = textDisplay.creditText.replace(
      "[NUMBER]",
      addCommas(Math.floor(playerData.bet))
    );
  }
}
...
function drawWheel() {
  ...
  if (gameSettings.secondWheel) {
    ...
    for (var n = 0; n < wheelSecond_arr.length; n++) {
      ...
      $.wheelInner[n] = new createjs.Bitmap(
        loader.getResult("wheelInnerH" + n)
      );
      ...
      if (wheelSecond_arr[n].slot != undefined) {
        ...
        if (wheelSecond_arr[n].slot.color != "") {
          ...
          var endAngle = Number(
            (360 / wheelSecond_arr.length) * (Math.PI / 180)
          );
          thisWheel.graphics
            .moveTo(0, 0)
            .arc(0, 0, gameSettings.secondWheelRadius, 0, endAngle, false)
            .closePath();
        ...
        if (wheelSecond_arr[n].slot.highlightColor != "") {
          ...
          $.wheelInner["slotH" + n].graphics
            .beginFill(wheelSecond_arr[n].slot.highlightColor)
            .setStrokeStyle(wheelSecond_arr[n].slot.stroke)
            .beginStroke(wheelSecond_arr[n].slot.strokeColor);
          $.wheelInner["slotH" + n].visible = false;
        ...
        if (wheelSecond_arr[n].slot.text != "") {
          ...
          $.wheelInner["slotText" + n].font =
            wheelSecond_arr[n].slot.fontSize + "px libel_suitregular";
          $.wheelInner["slotText" + n].lineHeight =
            wheelSecond_arr[n].slot.fontSize;
          $.wheelInner["slotText" + n].color =
            wheelSecond_arr[n].slot.textColor;
          ...
          $.wheelInner["slotText" + n].rotation =
            360 / wheelSecond_arr.length / 2;
...
function startSpinWheelInner() {
  ...
  if (gameData.spinDirection) {
    rotateNum = Math.abs(
      wheelInnerRadius * (rotateNum + 1) - wheelInnerRadius / 2
    );
  } else {
  ...
  TweenMax.to(wheelInnerContainer, totalRound, {
    ...
    onComplete: function () {
      ...
      //slot color feature
      if (
        wheelSecond_arr[gameData.wheelInnerNum].slot != undefined &&
        wheelSecond_arr[gameData.wheelInnerNum].slot.highlightColor != ""
      ) {
        $.wheelInner["slotH" + gameData.wheelInnerNum].visible = true;
        animateWheelSegment(
          $.wheelInner["slotH" + gameData.wheelInnerNum],
          true
        );

        wheelInnerContainer.setChildIndex(
          $.wheelInner["slot" + gameData.wheelInnerNum],
          wheelInnerContainer.numChildren - 1
        );
      }
...
function checkWheelScore() {
  ...
  TweenMax.to(playerData, 1, {
    ...
    onComplete: function () {
      playSound("soundTone");
      if (gameSettings.secondWheel) {
        var wheelInnerSegmentNumber =
          wheelSecond_arr[gameData.wheelInnerNum].mutiply;
        if (wheelSegmentType == 1) {
          ...
          statusTxt.text = textDisplay.statusText_arr[2].replace(
            "[NUMBER]",
            addCommas(wheelSegmentNumber)
          );
          var speedTween = 0.5;
          TweenMax.to(itemStatusBg, speedTween, {
            ...
            onComplete: function () {
              playSound("soundTone");
              statusTxt.text =
                textDisplay.statusText_arr[2].replace(
                  "[NUMBER]",
                  addCommas(wheelSegmentNumber)
                ) +
                " x " +
                wheelInnerSegmentNumber;
